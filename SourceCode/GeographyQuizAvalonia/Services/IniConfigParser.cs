...
namespace GeographyQuizAvalonia.Services // Changed namespace
{
    ...
    public class IniConfigParser
    {
        ...
        /// <returns>A dictionary representing the parsed INI data. Outer key is section, inner key is parameter. Returns null on error.</returns>
    ...
    public static class IniConfigExtensions
    {
        ...
        {
            if (config != null && config.TryGetValue(sectionName, out var section))
            {
